...
st.write('Created by: Ab Mohsin Bhat')
...
with col2:
    BloodPressureProblems = st.selectbox("High Blood Pressure?", ("No", "Yes"))
with col3:
    AnyTransplants = st.selectbox("If you had a Transplant?", ("No", "Yes"))
...
with col6:
    KnownAllergies = st.selectbox("Are you Allergic?", ("No", "Yes"))
with col7:
    HistoryOfCancerInFamily = st.selectbox("History of Family Cancer?", ("No", "Yes"))
with col8:
